  ...
  return (
    ...
    >
      ...
      <div className="container-custom relative z-30">
        <div className="max-w-4xl mx-auto text-center rounded-2xl bg-background/50 backdrop-blur-md border border-border/50 shadow-strong pl-4 pr-8 py-4 md:pl-8 md:pr-12 md:py-8">
          {/* Main Heading */}
